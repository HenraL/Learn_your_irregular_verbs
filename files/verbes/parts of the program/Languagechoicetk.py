...
Frame1=Frame(fenetre, borderwidth=2, relief=FLAT, bg=FBG)
Frame1.pack(side=LEFT, padx=10, pady=10)

#Frame1=LabelFrame(fenetre, text="Choose You're Language:", padx=10, pady=-10, bg=FBG, fg=FFG)
#Frame1.pack(fill="both",expand="yes")

Frame1Top=Frame(Frame1, borderwidth=2, relief=GROOVE, bg=FBG)
Frame1Top.pack(side=TOP, padx=10, pady=10, expand=YES)

Frame1bot=Frame(Frame1,borderwidth=2, relief=GROOVE, bg=FBG)
Frame1bot.pack(side=BOTTOM, padx=10, pady=10, expand=YES)

Frame1quit=Frame(Frame1,borderwidth=2, relief=FLAT, bg=FBG)
...
DE=Button(Frame1, text="German", font=(Font,Size), bg=WBG, fg=WFG, command=languageDE)#, value="D")
DE.pack(side=RIGHT,pady=0, expand=YES,padx=5)#fill=X)

EN=Button(Frame1,text="English", font=(Font,Size), bg=WBG, fg=WFG, command=languageE)#, value="E")
EN.pack(side=RIGHT,pady=0, expand=YES,padx=5)#fill=X)

FR=Button(Frame1,text="French", font=(Font,Size), bg=WBG, fg=WFG, command=languageF)#, value="F")
FR.pack(side=RIGHT,pady=0, expand=YES,padx=5)#fill=X)

ES=Button(Frame1,text="Spanish", font=(Font,Size), bg=WBG, fg=WFG, command=languageES)#, value="ES")
ES.pack(side=RIGHT,pady=0, expand=YES,padx=5)#fill=X)

bouton=Button(Frame1quit, text="Quit", font=(Font,Size), bg=WBG, fg=WFG, command=languagequit)
