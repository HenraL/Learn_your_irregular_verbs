#Key words for the dictionnary
#inf = infinitive = infinitif
#pras = präsen = présent
#prat = praterium = prétérit
#perf = perfeckt = parfait
#perf2 = perfekt2 = when there are two possibilites for the pereterit
#trad_fr = traduction française
#hint_fr = indice français
...
irregulier_DE=[
    ...
    {"inf":"bewerben","pras":"bewirbt sich","prat":"bewarb sich","perf":"hat sich beworben","trad_fr":"être candidat","hint_fr":"postuler","trad_eng":"to apply for","hint_eng":"to promote for"},
    {"inf":"bieten","pras":"bietet","prat":"bot","perf":"hat geboten","trad_fr":"offrir","hint_fr":"un cadeau","trad_eng":"to offer","hint_eng":"to give (a present)"},
    {"inf":"bitten","pras":"bittet","prat":"bat","perf":"hat gebeten","trad_fr":"demander","hint_fr":"invité à","trad_eng":"to ask","hint_eng":"to request"},
    {"inf":"bleiben","pras":"bleibt","prat":"blieb","perf":"ist geblieben","trad_fr":"rester","hint_fr":"demeurer","trad_eng":"to stay","hint_eng":"to remain"},
    ...
    {"inf":"ein/laden","pras":"lädt...ein","prat":"lud...ein","perf":"hat eingeladen","trad_fr":"inviter","hint_fr":"convier","trad_eng":"to invite","hint_eng":"to solicitate"},
    {"inf":"ein/treten","pras":"tritt...ein","prat":"trat...ein","perf":"ist eingetreten","trad_fr":"entrer","hint_fr":"pénetrer","trad_eng":"to occur","hint_eng":"to happen"},
    ...
    {"inf":"empfehlen","pras":"empfiehlt","prat":"empfahl","perf":"hat empfohlen","trad_fr":"recommander","hint_fr":"proposer","trad_eng":"to recomend","hint_eng":"to offer"},
    {"inf":"empfinden","pras":"empfindet","prat":"empfand","perf":"hat empfunden","trad_fr":"ressentir","hint_fr":"éprouver","trad_eng":"to feel","hint_eng":""},
    ...
    {"inf":"geschehen","pras":"geschieht","prat":"geschah","perf":"ist geschehen","trad_fr":"se produire","hint_fr":"","trad_eng":"to happen","hint_eng":""},
...
#,"trad_fr","hint_fr","trad_eng","hint_eng"
I=0
liist=["inf","pras","prat","perf"]
for I in range(len(liist)):
    print("{}\n\n".format(liist[I]))
    for words in range(len(irregulier_DE)):
        print("{}".format(irregulier_DE[words][liist[I]]))
        # print("I={}, words={}".format(I,words+12))
